...
const Select = ({ ...props }: React.ComponentProps<typeof Primitive.Root>) => (
	<Primitive.Root data-slot='select' {...props} />
);

const SelectGroup = ({
	...props
}: React.ComponentProps<typeof Primitive.Group>) => (
	<Primitive.Group data-slot='select-group' {...props} />
);

const SelectValue = ({
	...props
}: React.ComponentProps<typeof Primitive.Value>) => (
	<Primitive.Value data-slot='select-value' {...props} />
);
